...
this.state['inventory_stage'] = 'v0.1';
this.state['isInventoryUnlocked'] = false;
this.state['inventory'] = [
    { 
        id: 'hogwarts_letter', 
        name: '录取通知书', 
        icon: '✉️', 
        description: '一封由羊皮纸写成的信，上面印着霍格沃茨的校徽。',
        type: 'plugin',
        pluginPath: 'hogwarts_letter' 
    },
    { 
        id: 'shopping_list', 
        name: '用品清单', 
        icon: '📜', 
        description: '一年级新生需要准备的课本、袍子和坩埚清单。' 
    },
    { 
        id: 'train_ticket', 
        name: '特快车票', 
        icon: '🎫', 
        description: '伦敦到霍格沃茨的单程票，九又四分之三站台。' 
    }
];
    }
